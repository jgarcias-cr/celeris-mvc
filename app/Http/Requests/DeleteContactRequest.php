...
final class DeleteContactRequest extends FormRequest
{
   ...
   {
      return $resource instanceof Contact && $this->policy->delete($ctx, $resource);
   }
   ...
   {
      return 'You are not authorized to delete this contact.';
   }
}
